...
@pytest.fixture
def azure_adls_clean_up(context, container_name: str, ingest_directory_name: str):
...
@pytest.fixture
def azure_blob_config_prepare(context, data_target_directory: str, data_local_directory: str):
