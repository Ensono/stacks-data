...
def generate_pipeline(validated_config: WorkloadConfigBaseModel, dq_flag: bool) -> str:
    ...
    template_source_path = (template_source_path, path_separator)
    ...
    if dq_flag:
        ...
        template_source_path = os.path.join(TEMPLATES_DIRECTORY, workload_type, template_source_folder) + path_separator
        template_source_path = (template_source_path, path_separator)
        render_template_components(validated_config, template_source_path, target_dir)
